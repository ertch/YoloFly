...
object ButterflyRepository {
    fun getAllButterflies(): List<Butterfly> {
        return listOf(
            ...
            Butterfly(3, "Blue Morpho", "Species 2", android.R.drawable.ic_menu_gallery,
                "Brilliant blue wings that shimmer in the sunlight.",
                "Tropical rainforests", "12.7-20.3 cm", "Year-round"),
            Butterfly(4, "Painted Lady", "Species 2", android.R.drawable.ic_menu_gallery,
                "One of the most widespread butterflies in the world.",
                "Gardens, fields, and roadsides", "5.1-7.3 cm", "March to October"),
            Butterfly(5, "Red Admiral", "Species 3", android.R.drawable.ic_menu_gallery,
                "Dark wings with red bands and white spots.",
                "Gardens, parks, and woodland edges", "4.5-6.0 cm", "March to October"),
            Butterfly(6, "Cabbage White", "Species 3", android.R.drawable.ic_menu_gallery,
                "Small white butterfly commonly found in gardens.",
                "Gardens and agricultural areas", "3.2-5.1 cm", "March to November"),
            Butterfly(7, "Tiger Swallowtail", "Species 4", android.R.drawable.ic_menu_gallery,
                "Large yellow butterfly with black tiger stripes.",
                "Deciduous forests and gardens", "7.9-14 cm", "March to November"),
            Butterfly(8, "Zebra Longwing", "Species 4", android.R.drawable.ic_menu_gallery,
